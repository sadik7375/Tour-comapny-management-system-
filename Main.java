...
public class Main {
    public static void main(String[] args) {
    	...
    	Hotel h1 = new RegularPack ("India", "Hotel bombay", 131);
    	...
    	Hotel h2 = new AveragePack ("Bali", "Hotel palace", 231);
    	...
    	Hotel h3 = new SwishPack ("Singapore", "Hotel Royal", 331);
       ...
       System.out.println("              Our Phone Number: "+t1.getPhoneNo());//calling getPhoneNo method through t1 object
    	 ...
    	 System.out.println("              1. Starter Pack : India (2 days 2 night) ");
    	 System.out.println("              2. Gold Pack : Bali (3 days 2 night) ");
    	 System.out.println("              3. Premium Pack : Singapore (3 days 3 night) ");
       ...
       switch(ch)  
        ...
        case 1:
            ...
            System.out.println("     ----------------------------------------------");
            System.out.println();
            RegularPack r1 = new RegularPack ("India", "Hotel bombay", 131);// Create an RegularPack object for 1st tourpackage
            System.out.println("          =======================             ");
        ...
        case 2: 
            ...
            System.out.println("     ----------------------------------------------");
            System.out.println();
            AveragePack av1 = new AveragePack ("Bali", "Hotel palace", 231);// Create an AveragePack object for 2nd tourpackage
            System.out.println("          =======================             ");
            System.out.println("              ---Hotel Info---         ");
            System.out.println("          =======================             ");
            System.out.println();
        ...
        case 3:
            ...
            System.out.println("     ----------------------------------------------");
            System.out.println();
            SwishPack sw1 = new SwishPack ("Singapore", "Hotel Royal", 331);
            System.out.println("          =======================             ");
            System.out.println("              ---Hotel Info---         ");
            System.out.println("          =======================             ");
            System.out.println();
       ...
       int nid= n1.nextInt(); // Input Integer value in nid variable 
